...
After completing the Amazon SES configuration and connecting the backend, create or update an appointment in the system to test the email sending functionality.
